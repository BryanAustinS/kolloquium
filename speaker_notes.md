...
Budget: intro block (1–5) ≈ 5 min · method block (6–10) ≈ 5 min · results block (11–14) ≈ 6 min · answers & closing (15–18) ≈ 4 min.
...
## 5 · Related Work — the Gap (0:45)

- Jasra et al.: unsupervised ML on real flight data — but no rules.
- Mohite & Ouarbya: hybrid rules + ML — but not on aviation data.
- Nobody combines both **on tabular flight data in one system**. That's the gap this thesis fills.
...
## 7 · Stage 1 — How a Record Gets Its Label (1:30)
...
## 10 · Training for Rare Anomalies (1:00)
...
## 11 · Results — What Moved the Needle (1:30)

- Read the ladder bottom-up: Dummy 0.027 → LogReg 0.131 (even tuned) → LightGBM raw already 0.317 → features alone change little → **tuning unlocks it: 0.493**.
- The three levers: tuning decisive (only for LightGBM), data volume decisive (only for LightGBM), features only help if route-independent.
- Punchline: **LightGBM ≈ 3.8× LogReg ≈ 18× no-skill**. Only the non-linear model can use the interactions that define an anomaly.

## 12 · The Final Model (1:30)
...
## 13 · Choosing the Operating Point (1:00)
...
## 17 · Limitations & Future Work (1:00)
...
- 5→6: "So how do we actually combine them?"
- 10→11: "So what did all of this buy us?"
- 14→15: "With those numbers in hand, back to the research questions."
- 16→17: "To be fair about what these results can and cannot claim…"
